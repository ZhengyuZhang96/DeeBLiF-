...
def test_model():
    ...
    valset_dir = './Datasets/PVBLiF_Win5_5x5_32x32/'
    dataset_name = 'Win5'
    ...
    distorted_num = 5
    scene_num = 10
    dist = 'HEVC'  # HEVC, JPEG2000, LN, NN
    Dist_DICT = []

    ### NBU
    # load_all_model_path = './PreTrainedModels/NBU/'
    # valset_dir = './Datasets/PVBLiF_NBU_5x5_32x32/'
    # dataset_name = 'NBU'
    ...
    for id, model_name in enumerate(test_scene_id_list):
        load_model_path = load_all_model_path + '/' + \
                          str(model_name[0]) + '_' + str(model_name[1]) + '/PVBLiF_epoch70.pth.tar'
    ...
    f = h5py.File('./Results/PVBLiF_result_' + dataset_name + '_' + dist + '.h5', 'w')
